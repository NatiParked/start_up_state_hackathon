...
|-------|--------|---------|-----------|
| Phase 1: Database Migrations | Pending | — | — |
...
|------|--------|----------|----------|
| 1.1: Create supabase/migrations/0004_pg_cron.sql | Pending | 1 | — |
| 1.2: Create supabase/migrations/0005_refresh_log.sql | Pending | 2 | — |
| 1.3: Apply both migrations to Supabase | Pending | 3 | — |
